...
const createDefaultState = (network: 'mainnet' | 'testnet' = 'mainnet'): Omit<OrderBookFilterState, '_hasHydrated'> => ({
...
export const useOrderBookFiltersOnly = () =>
  useOrderBookFilterStore((state) => state.filters)
...
export const useHasHydrated = () =>
  useOrderBookFilterStore((state) => state._hasHydrated)
