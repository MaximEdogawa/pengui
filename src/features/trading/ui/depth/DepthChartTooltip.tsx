import { formatPriceForDisplay, formatAmountForDisplay } from '../../lib/formatAmount'
    ...
    >
      <div className="flex flex-col gap-1 text-xs">
        <div className="flex items-center gap-2">
          ...
          <span className={`font-mono font-medium ${tooltip.side === 'bid' ? 'text-[#26a69a]' : 'text-[#ef5350]'}`}>
