...
export default function TradeHistoryContainer({
  ...
  return (
    <div className={`${t.card} h-full flex flex-col overflow-hidden`}>
      ...
      <div
        className={`flex-shrink-0 flex flex-wrap items-center justify-between gap-2 px-2 py-1.5 border-b ${t.border}`}
      >
        ...
        <div
          className={`flex items-center gap-3 px-2 py-1 rounded-lg backdrop-blur-xl bg-white/5 dark:bg-black/5 border border-white/10 dark:border-white/5 ${t.text}`}
        >
