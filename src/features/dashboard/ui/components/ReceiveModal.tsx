      ...
      <div className="p-4">
        ...
        <div className="flex justify-center mb-4">
          <div className="rounded-xl p-3 bg-white">
            <QRCodeSVG value={address} size={180} level="M" marginSize={0} />
          </div>
        </div>

        {/* Address label */}
        <p
          className={`${t.textSecondary} text-[10px] font-medium uppercase tracking-wide mb-1.5 text-center`}
        >
          Your XCH Address
        </p>
        ...
        >
          <span className={`flex-1 text-xs font-mono ${t.text} break-all leading-relaxed`}>
            {address}
          </span>
