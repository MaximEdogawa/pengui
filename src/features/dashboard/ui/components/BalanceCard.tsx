          ...
          <div>
            ...
            {isLoading ? (
              <div className="space-y-2">
                <div
                  className={`h-7 w-36 rounded-lg ${isDark ? "bg-white/[0.06]" : "bg-slate-200/60"} animate-pulse`}
                />
                <div
                  className={`h-3 w-20 rounded-md ${isDark ? "bg-white/[0.04]" : "bg-slate-200/40"} animate-pulse`}
                />
              </div>
            ) : (
              <>
