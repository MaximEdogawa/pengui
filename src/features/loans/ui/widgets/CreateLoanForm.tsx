  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <LoanAssetSection formData={formData} onUpdate={updateFormData} isDark={isDark} t={t} />
        ...
        <LoanTermsSection
          ...
          t={t}
        />
        <CollateralSection formData={formData} onUpdate={updateFormData} isDark={isDark} t={t} />
