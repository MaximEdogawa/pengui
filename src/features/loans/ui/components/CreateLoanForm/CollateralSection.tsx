  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-3">
        <Shield className={isDark ? "text-cyan-400" : "text-cyan-700"} size={14} strokeWidth={2} />
      ...
      <div className="space-y-3">
        ...
        {formData.collateralAssetType === "CAT" && (
          <div>
            <label className={`${t.textSecondary} text-[10px] font-medium mb-1 block`}>Asset</label>
            <AssetSelector
              asset={
                {
                  assetId: formData.collateralType || "",
                  type: "cat",
                  amount: formData.collateralRatio || 0,
                  symbol: "",
                } as ExtendedAsset
              }
