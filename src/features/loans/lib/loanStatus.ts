 ...
 */
export function getLoanStatusColors(status: LoanOffer["status"], isDark: boolean): string {
  if (status === "available") {
    return isDark
 ...
 */
export function getCollateralAssetTypeColors(assetType: string, isDark: boolean): string {
