    ...
    <div className="space-y-1.5 text-xs">
      {removeReceive ? (
        <>
          ...
          <div className={`flex justify-between items-start border-t ${t.border} pt-1.5 mt-1.5`}>
...
export function AddPreviewTabContent({
  ...
  return (
    <div className="space-y-1.5 text-xs">
      <div className="flex justify-between items-start">
        <span className={t.textSecondary}>Offered</span>
        <span className={`${t.text} inline-flex items-center gap-1 justify-end`}>
          {offeredTicker && (
            <>
      ...
      <div className={`flex justify-between items-start border-t ${t.border} pt-1.5 mt-1.5`}>
        <span className={t.textSecondary}>Requested</span>
        <span className={`${t.text} inline-flex items-center gap-1 justify-end`}>
          {requestedTicker && (
            <>
