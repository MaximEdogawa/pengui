    ...
    <div className="w-full relative z-10">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className={`text-xl lg:text-2xl font-semibold ${t.text} mb-0.5`}>Piggy Bank</h1>
      ...
      >
        <div className="flex flex-col items-center justify-center py-4">
          ...
          <p className={`${t.textSecondary} text-center text-sm max-w-md`}>
            Piggy bank features will be available here soon. Check back later for updates.
          </p>
        </div>
      </div>
    </div>
