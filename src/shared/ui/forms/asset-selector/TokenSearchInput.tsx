...
import { useNetwork, useThemeClasses } from '@/shared/hooks'
...
interface TokenSearchInputProps {
  ...
  /** All available tokens (used to find icon for selected token) */
  allTokens?: Token[]
}
...
export default function TokenSearchInput({
  ...
  // Check if this is XCH/TXCH
  const isXch = selectedToken && (!selectedToken.assetId || selectedToken.ticker === 'XCH' || selectedToken.ticker === 'TXCH')
    ...
    <div className="relative">
      <div className="relative flex items-center">
        ...
        {selectedToken && (
          ...
          >
            {isXch ? (
              <XchIcon size={18} isTestnet={isTestnet} />
            ) : (
              <TokenIconAuto
