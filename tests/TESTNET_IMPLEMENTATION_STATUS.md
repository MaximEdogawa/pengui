...
For the canonical test taxonomy, see [`TESTING.md`](./TESTING.md).
...
- The wallet runtime described in [`WALLET_RUNTIME_IMPLEMENTATION_SPEC.md`](./WALLET_RUNTIME_IMPLEMENTATION_SPEC.md) does not exist yet.
...
2. Build the wallet runtime from [`WALLET_RUNTIME_IMPLEMENTATION_SPEC.md`](./WALLET_RUNTIME_IMPLEMENTATION_SPEC.md) in a separate ticket.
3. Implement `e2e-testnet-live` from [`E2E_TESTNET_LIVE_SPEC.md`](./E2E_TESTNET_LIVE_SPEC.md).
4. Treat `e2e-mainnet-live` as a stricter later phase from [`E2E_MAINNET_LIVE_SPEC.md`](./E2E_MAINNET_LIVE_SPEC.md).
