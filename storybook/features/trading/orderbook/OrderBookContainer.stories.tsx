...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Orderbook with mocked data showing buy and sell orders. The data is automatically generated with realistic prices and amounts.",
      },
    },
  },
};
...
export const WithFilters: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Orderbook filtered to show only XCH/USDT orders. The mock data is filtered based on the provided asset filters.",
      },
    },
  },
};
...
export const Empty: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Empty orderbook state when no orders match the filters. This demonstrates the empty state UI.",
      },
    },
  },
};
